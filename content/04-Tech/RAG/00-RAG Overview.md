...
> Definition: a method where an AI model first retrieves relevant information from **external sources** (documents, databases, web pages), then uses that **retrieved content** to generate a more **accurate** answer.
